...
public class DataUtils {
    ...
    public static String jsonResponse(String id, int code, String errMsg, String jsonData) {
    ...
    public static String jsonRequest(String id, String op, String jsonData, String destDevice) {
    ...
    public static String jsonRequest(String id, String op, String jsonData) {
