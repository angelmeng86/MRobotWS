...
public class MRobotClient2 extends WebSocketClient {

	public boolean running = true;
	private boolean logined = false;

	public MRobotClient2(URI serverUri, Draft draft) {
		super(serverUri, draft);
	}

	public MRobotClient2(URI serverURI) {
		super(serverURI);
	}
	...
	public static void main(String[] args) throws URISyntaxException, InterruptedException {
		...
		MRobotClient2 client = new MRobotClient2(new URI("ws://www.ucicloud.com:8085"));
		client.connect();
